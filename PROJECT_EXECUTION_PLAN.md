...
- 1.4 🟢 Routing and application state foundation
- 1.5 🟢 Domain models and persistence interfaces foundation
- 1.6 🟢 Error/loading/empty-state framework primitives
- 1.7 🟢 Configuration and environment handling foundation
...
- 3.7 🟡 Page preview/gallery foundation
- 3.8 🟢 Parent Approve workflow foundation
- 3.9 🟢 Wrong-source / Replace workflow foundation
- 3.10 🔴 Parent chapter upload
- 3.11 🔴 OCR/document ingestion pipeline
- 3.12 🟢 Parent-uploaded source authoritative rule
- 3.13 🔴 Topic/concept extraction
- 3.14 🟡 Curriculum search/navigation foundation
...
- 4.3 🟡 Curriculum-grounded context foundation
- 4.4 🔴 Teaching-plan generator
- 4.5 🟡 Child-level adaptation foundation
- 4.6 🟡 Socratic questioning / interaction foundation
- 4.7 🔴 Explanation + examples engine
- 4.8 🔴 Knowledge-check engine
- 4.9 🔴 Mistake diagnosis
- 4.10 🔴 Remediation/reteach engine
- 4.11 🟢 Mastery scoring foundation
- 4.12 🟢 Session memory and progress foundation
...
- 5.5 🟡 Tutor request routing foundation
- 5.6 🔴 Text-to-speech
...
- 6.4 🟡 Teaching style foundation
- 6.5 🔴 Teacher greeting/opening routine
- 6.6 🟡 Explain/ask/check/reteach foundation
- 6.7 🟡 Teacher memory of current lesson foundation
- 6.8 🟡 Teacher + curriculum integration foundation
- 6.9 🔴 Teacher + voice integration
- 6.10 🟡 Teacher regression tests foundation
...
- 7.5 🟡 Idle/listening/thinking/speaking state foundation
...
- 8.4 🟡 Curriculum workflow tests foundation
