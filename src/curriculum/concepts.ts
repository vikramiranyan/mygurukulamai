...
const STOP_WORDS = new Set(['the','and','for','with','this','that','from','into','about','their','have','will']);

/** Lightweight deterministic concept extraction; richer NLP can be injected later. */
